...
export const clasz: { [key: number]: string } = {
    0: 'none',
    1: '32',
    2: '64',
    3: 'num'
...
export const endian: { [key: number]: string } = {
    0: 'none',
    1: 'lsb',
    2: 'msb',
    3: 'num'
...
export const version: { [key: number]: string } = {
    0: 'none',
    1: 'current',
    2: 'num'
};

export const osabi: { [key: number]: string } = {
    0: 'sysv',
    1: 'hpux',
    2: 'netbsd',
    3: 'linux',
...
export const abiversion: { [key: number]: string } = {
    0: 'none',
    1: 'current',
    2: 'num'
};

export const machine: { [key: number]: string } = {
    0: 'none',
    1: 'm32',
    2: 'sparc',
    3: '386',
...
export const entryType: { [key: number]: string } = {
    0: 'null',
    1: 'load',
    2: 'dynamic',
    3: 'interp',
...
export  const entryFlags: { [key: number]: string } = {
    4: 'r',
    2: 'w',
    1: 'x',
...
export const sectType: { [key: number]: string } = {
    0: 'undef',
    // 0: 'null',
    1: 'progbits',
    2: 'symtab',
...
export const sectFlags: { [key: number]: string } = {
    0x01: 'write',
    0x02: 'alloc',
    0x04: 'execinstr',
    0x10: 'merge',
